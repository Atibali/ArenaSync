...
import { ClipboardList, CheckCircle2, User, MapPin, Sparkles, Languages, Volume2, HelpCircle, RefreshCw, Award, Trophy, Star, ShieldCheck } from 'lucide-react';
...
export default function VolunteerTasks({ stadiumState, onCompleteTask }: VolunteerTasksProps) {
  ...
  return (
    <div className="space-y-6" id="volunteer-desk-widget">
      
      {/* PHASE 2: Volunteer Shift Impact & Gamification Leaderboard Bar */}
      <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-display font-bold text-slate-800 text-sm">
                Volunteer Shift Impact & Eco Gamification
              </h3>
              <p className="text-[11px] text-slate-500 font-sans">
                Earn badges and track real-time fan assistance milestones for Matchday 1.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 font-mono text-xs">
            <span className="bg-emerald-50 text-emerald-800 border border-emerald-200 px-3 py-1 rounded-full font-bold">
              ★ {completedTasks.length * 150 + 450} Volunteer Points
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-bold text-slate-800 block">Eco Champion Badge</span>
              <span className="text-[10px] text-slate-500 font-sans">1,240 Reusable Cups Recycled</span>
            </div>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-bold text-slate-800 block">Multilingual Bridge</span>
              <span className="text-[10px] text-slate-500 font-sans">4 Global Dialects Active</span>
            </div>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-bold text-slate-800 block">Transit Protocol Officer</span>
              <span className="text-[10px] text-slate-500 font-sans">Gate C Crowd Safety Unlocked</span>
            </div>
          </div>
        </div>
      </div>
